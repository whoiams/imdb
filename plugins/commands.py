...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/filmstudiodl')
            ],
            [
        ...
        await client.send_sticker(chat_id=message.chat.id, sticker='CAACAgUAAxkBAAJ1k2IfDr7l8Hat1fghd-s1mnbBEsFXZWJAAL5BAACAdz5VOVw2x38ZZJ1HgQ',  reply_markup=reply_markup, reply_to_message_id=message.message_id)
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('📡 ᴜᴘᴅᴀᴛᴇꜱ 📡', url='https://t.me/filmstudidl'),
            InlineKeyboardButton('📡 ꜰɪʟᴍ ꜱᴛᴜᴅɪᴏ 📡', url='https://t.me/FilmStudiohub2')
            ],[
            InlineKeyboardButton('❌ ᴄʟᴏꜱᴇ ᴛʜᴇ ᴍᴇɴᴜ ❌', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
